...
public class BaseApplicationConfiguration {
	...
	*/
	...
	public final static class Urls{
		private static final String ERROR_URL_KEY = "url.error";
		private static final String EVENT_URL_KEY = "url.event";
		private static final String RESOURCES_URL_KEY = "url.resources";
		
		private static String errorUrl;
		public static String getErrorUrl(){
			if(null == errorUrl){
				errorUrl = getValue(ERROR_URL_KEY, true);
			}
			return errorUrl;
		}
		...
		public static String getEventUrl(){
			if(null == eventUrl){
				eventUrl = getValue(EVENT_URL_KEY, true);
			}
			return eventUrl;
		}
		...
		public static String getResourcesUrl() {
			if(null == resourcesUrl){
				resourcesUrl = getValue(RESOURCES_URL_KEY, true);
			}
			return resourcesUrl;
		}
	}

	private static final String SYSTEM_TEMPLATES_FOLDER_KEY = "system-templates-folder";
