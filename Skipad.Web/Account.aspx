...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="content-middle-tabs-section">
		<div class="content-middle-tabs">
	    	<ul class="content-middle-tabs-container">
				...
				<li><a href="account.aspx" class="selected" title="Account"><span>Account</span></a></li>
	    	</ul>
    	</div>
    </div>
    <div style="clear: both; padding-top: 20px;">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td valign="top" style="width: 450px">
					<h3 class="light-header-white">Account Details</h3>
					<div style="padding-top: 10px">
		<div class="params">
			<div class="param-name">* Account Name:</div>
			<div class="param-value">
				<div><input id="text_account_name" name="account_name" type="text" autocomplete="off" /></div>
				<div><label id="status_account_name"></label></div>
			</div>
		</div>
		<div class="params">
			<div class="param-name">External Account Id:</div>
			<div class="param-value"><b id="label_external_account_id"></b></div>
		</div>
		<div class="params">
			<div class="param-name">Create Date:</div>
			<div class="param-value"><b id="label_create_date"></b></div>
		</div>
		...
		<div class="params">
			...
			<div class="param-value">
				<a id="button_update" class="button-green" title="Update"><span>Update</span></a>
			</div>
		</div>
					</div>
				</td>
