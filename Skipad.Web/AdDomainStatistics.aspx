<%@ Page Title="AdDomainStatistics" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AdDomainStatistics.aspx.cs" Inherits="AdDomainStatistics" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
    	<tr>
    		<td valign="top">
    			...
    			<h1><span style="color: #666666">Ad:</span> <a id="ad_name"></a>&nbsp;&rsaquo;&nbsp;<a id="ad_statistics" title="Referrals">Referrals</a>&nbsp;&rsaquo;&nbsp;<span id="domain_name"></span></h1>
    		</td>
    		<td valign="top">
...
var exportTo = function(params) {
	...
	var name = encodeURIComponent(_campaignName + " " + _adName + " " + params.domain + " " + (defaultState.fromDate).replace(":", "") + "-" + (defaultState.toDate).replace(":", ""));
		...
		success : function(_data) {
			...
			getAd({
				...
				success : function(data) {
					...
					$("#ad_name")
					.text(data.adName)
					.attr({ "href" : "ad.aspx?ad_id=<%=AdId%>", "title" : data.adName });
					
					$("#ad_statistics")
					.attr("href", "adstatistics.aspx?ad_id=<%=AdId%>");
