 ...
 * 
 * @example $.cookie('the_cookie', 'the_value', {expires: 7, FilePath: '/', domain:
 ...
 * @option String FilePath The value of the FilePath atribute of the cookie (default:
 *         FilePath of page that created the cookie).
...
jQuery.cookie = function(name, value, options) {
	if (typeof value != 'undefined') { // name and value given, set cookie
		...
		var path = options.path ? '; FilePath=' + options.path : '';
